...
class StorageMethods {
  ...
  Future<String> uploadImage(String folderName, Uint8List image, bool isUserPost) async {
    // Uploads the given image to /folderName/<currentUserUID>
    Reference ref = storage.ref().child(folderName).child(auth.currentUser!.uid);
